...
public class provideShippingAddressDetails {
    ...
    private static def execute_functional_method(Map data) {
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_checkout/input_country'), data['input_country'])
        ...
        WebUI.setText(findTestObject('AI-Generated/Page_checkout/input_postcode'), data['input_postcode'])
    }
